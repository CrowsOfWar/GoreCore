...
/**
 * Provides a variety of numerical functions related to math and random
 * numbers.
 * 
 * @author CrowsOfWar
 */
public final class GoreCoreMathHelper {
	 ...
	 * @param min The minimum number in that range
	 * @param max The maximum number in that range
